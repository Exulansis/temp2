...
const verifySignature = (data, signature, pKey, keyType) => {
    ...
    return vaulted_key_provider_1.getCryptoProvider(native_core_1.cryptoUtils).verify(pKey, compatibilityMap[keyType] || keyType, data, signature).catch(e => { throw new Error("SignatureVerificationFailed: " + e.message); });
};
