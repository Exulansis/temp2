...
const ecdsaKoblitzSignature2016_1 = require("../../linkedDataSignature/suites/ecdsaKoblitzSignature2016");
...
let DidDocument = DidDocument_1 = class DidDocument {
    constructor() {
        ...
        this._proof = new ecdsaKoblitzSignature2016_1.EcdsaLinkedDataSignature();
...
__decorate([
    ...
    class_transformer_1.Transform(({ value }) => value && value.map(sections_1.PublicKeySection.fromJSON))
...
__decorate([
    class_transformer_1.Expose(),
    class_transformer_1.Type(() => ecdsaKoblitzSignature2016_1.EcdsaLinkedDataSignature),
    class_transformer_1.Transform(value => value || new ecdsaKoblitzSignature2016_1.EcdsaLinkedDataSignature(), {
        toClassOnly: true,
    })
