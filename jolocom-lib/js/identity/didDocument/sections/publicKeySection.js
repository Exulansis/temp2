...
__decorate([
    ...
    class_transformer_1.Transform(({ value, obj }) => value || (obj.id && obj.id.split('#')[0]), {
        toClassOnly: true,
        until: 0.13,
    }),
    class_transformer_1.Transform(({ value, obj }) => obj.owner || value, { toClassOnly: true, until: 0.13 })
...
__decorate([
    class_transformer_1.Expose(),
    class_transformer_1.Transform(({ value, obj }) => !value && obj.publicKeyBase64
